// file: .sm_asn-list.h - List template classes
//  RWC; This template class was moved from eSNACC c++-lib/inc directory
//  RWC;  to libCtilMgr since eSNACC now uses the std::list class.
//  RWC;  (The SFL will eventually be moving to std::list as well.)
#ifndef _CLM_sm_asn_list_H_
#define _CLM_sm_asn_list_H_
